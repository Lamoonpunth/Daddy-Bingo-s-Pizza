...
const RegInfoText = () => {
  ...
  const [selectedSubDist, setSelectedSubDist] = React.useState('');
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.dropdownaddress}>
        <View style={styles.pickeraddressbox}>
          <Picker style={styles.pickeraddress}
        ...
        <View style={styles.pickeraddressbox}>
          <Picker style={styles.pickeraddress}
            selectedValue={selectedSubDist}
            dropdownIconColor='#FF6D6D'
            mode='dropdown'
            prompt= "SubDistrict"
            onValueChange={(itemValue) =>
              setSelectedSubDist(itemValue)
            }>
